...
namespace Nomis.PolygonId.Interfaces.PolygonIdIssuerNode
{
    ...
    public partial interface IPolygonIdIssuerClient
    {
        ...
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<KeyValue>> GetConfigAsync();
        ...
        /// <returns>Config</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<KeyValue>> GetConfigAsync(System.Threading.CancellationToken cancellationToken);
        ...
        /// <returns>Identity top up successfully</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetIdentityDetailsResponse> GetIdentityDetailsAsync(string identifier);
        ...
        /// <returns>Identity top up successfully</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetIdentityDetailsResponse> GetIdentityDetailsAsync(string identifier, System.Threading.CancellationToken cancellationToken);

        /// <summary>
        /// Retry Publish Identity State
        /// </summary>
        /// <param name="identifier">Issuer identifier</param>
        /// <returns>Publish state successfully</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PublishIdentityStateResponse> RetryPublishStateAsync(string identifier);
        ...
        /// <returns>Publish state successfully</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PublishIdentityStateResponse> RetryPublishStateAsync(string identifier, System.Threading.CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <remarks>
        /// Returns a previously generated QR code via url shortener method
        /// </remarks>
        /// <returns>A json to generate a QR code</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<object> GetQrFromStoreAsync(string id);
        ...
        /// <returns>A json to generate a QR code</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<object> GetQrFromStoreAsync(string id, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class PolygonIdIssuerClient : IPolygonIdIssuerClient
    {
        ...
        /// <returns>Config</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<KeyValue>> GetConfigAsync()
        {
        ...
        /// <returns>Config</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<KeyValue>> GetConfigAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
        ...
        /// <returns>Identity top up successfully</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetIdentityDetailsResponse> GetIdentityDetailsAsync(string identifier)
        {
            return GetIdentityDetailsAsync(identifier, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Identity top up successfully</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetIdentityDetailsResponse> GetIdentityDetailsAsync(string identifier, System.Threading.CancellationToken cancellationToken)
        {
            if (identifier == null)
                throw new System.ArgumentNullException("identifier");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v1/identities/{identifier}/details");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetIdentityDetailsResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new PolygonIdApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>Publish state successfully</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<PublishIdentityStateResponse> RetryPublishStateAsync(string identifier)
        {
            return RetryPublishStateAsync(identifier, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Publish state successfully</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PublishIdentityStateResponse> RetryPublishStateAsync(string identifier, System.Threading.CancellationToken cancellationToken)
        {
            if (identifier == null)
                throw new System.ArgumentNullException("identifier");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v1/{identifier}/state/retry");
            urlBuilder_.Replace("{identifier}", System.Uri.EscapeDataString(ConvertToString(identifier, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>A json to generate a QR code</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<object> GetQrFromStoreAsync(string id)
        {
            return GetQrFromStoreAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>A json to generate a QR code</returns>
        /// <exception cref="PolygonIdApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<object> GetQrFromStoreAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v1/qr-store?");
            if (id != null)
            {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.0.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.3.0))")]
    public partial class Config : System.Collections.ObjectModel.Collection<KeyValue>
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.0.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.3.0))")]
    public partial class GetIdentityDetailsResponse
    {
        [Newtonsoft.Json.JsonProperty("identifier", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Identifier { get; set; }
    ...
    public partial class DidMetadata
    {
        ...
        public DidMetadataType Type { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.18.0.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.3.0))")]
    public enum DidMetadataType
    {

        [System.Runtime.Serialization.EnumMember(Value = @"BJJ")]
        BJJ = 0,
